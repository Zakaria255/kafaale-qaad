...
// No fake fallback content — an empty/missing local cache just means no
// updates have loaded yet, resolved once the real API answers.
function getUpdates() {
  try { return JSON.parse(localStorage.getItem(UPDATES_KEY) || "null") || []; }
  catch { return []; }
}
