...
/**
 * <Logo /> — Kafaala Qaad Foundation brand logo
 * Props:
  ...
  const inner = (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: dark ? "0 2px 14px rgba(0,0,0,0.30)" : "0 2px 10px rgba(17,42,99,0.15)",
        border: dark ? "2px solid rgba(250,165,40,0.5)" : "2px solid rgba(17,42,99,0.12)",
      }}>
        <img
          src="/assets/brand/kafaala-qaad-hope-icon.png"
          alt="Kafaala Qaad Foundation"
